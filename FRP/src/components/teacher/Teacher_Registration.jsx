...
export default function Teacher_Registration() {
    ...
    const savedata = async () => {
        try {
            ...
            await setDoc(doc(db, "teacherData", generateId), formData);
            ...
            <div className="col-span-12 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div className="space-y-6 border-t border-gray-100 p-5 dark:border-gray-800">
                    <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="absolute">
                                    ...
                                    <div className="pointer-events-none absolute inset-y-0 right-3 flex items-center text-gray-700 dark:text-gray-400">
                                        <svg className="stroke-current" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path d="M4.79175 7.396L10.0001 12.6043L15.2084 7.396" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </div>
                                </div>
                                <input
                        ...
                        <div className="col-span-12 md:col-span-4 mt-6  ">
                            <button
                                onClick={savedata}
